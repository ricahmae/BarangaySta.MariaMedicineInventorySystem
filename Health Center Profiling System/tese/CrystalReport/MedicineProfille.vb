...
Public Class MedicineProfille
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Health_Center_Profiling_System.MedicineProfille.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMedicineProfille
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MedicineProfille = New MedicineProfille()
        rpt.Site = Me.Site
        Return rpt
    End Function
