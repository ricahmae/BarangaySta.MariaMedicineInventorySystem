...
Public Class NearExpiration
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Health_Center_Profiling_System.NearExpiration.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNearExpiration
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NearExpiration = New NearExpiration()
        rpt.Site = Me.Site
        Return rpt
    End Function
