Public Class ViewLotNumber
    Public lid As Integer
    Public lname As String
    Private Sub ViewLotNumber_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub ViewData()
        Try
            ...
            Dim i As Integer = 0
            dbConnect()
            sql = "SELECT * FROM lotnumber ORDER BY LotNumber"
            ExecuteQuery(sql)
    ...
    Private Sub LotDG_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles LotDG.CellContentClick
        If e.ColumnIndex = 3 Then
            ...
            Dim i As Integer = 0
            dbConnect()
            sql = "SELECT * FROM lotnumber WHERE LotNumberID = " & id & " LIMIT 1"
            ExecuteQuery(sql)
    ...
    Public Sub searchstock(tb As String)
        Try
            ...
            dbConnect()
            Dim i As Integer = 0
            query = "SELECT * FROM lotnumber WHERE " _
                                  & " LotNumber Like '" & tb & "%'
                                   ORDER BY LotNumber"
