Public Class ViewType
    ...
    Public Sub searchstock(tb As String)
        Try
            ...
            dbConnect()
            Dim i As Integer = 0
            query = "SELECT * FROM type WHERE " _
                                  & " TypeName Like '" & tb & "%'
                                   ORDER BY TypeName"
    ...
    Sub ViewData()
        Try
            ...
            While reader.Read()
                i = i + 1
                With TypeDG
                    .Rows.Add(reader(0), i, reader(1), "Add SubType", ("Edit"))
                End With
            End While
            reader.Close()
            TypeDG.ClearSelection()
    ...
    Private Sub TypeDG_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles TypeDG.CellContentClick
        If e.ColumnIndex = 3 Then


            Dim id As Integer
            id = (TypeDG.SelectedRows(0).Cells(0).Value)

            Dim sql As String
            Dim i As Integer = 0
            dbConnect()
            sql = "SELECT * FROM type WHERE TypeID = " & id & " LIMIT 1"
            ExecuteQuery(sql)
    ...
    Private Sub TypeDG_CellPainting(sender As Object, e As DataGridViewCellPaintingEventArgs) Handles TypeDG.CellPainting
