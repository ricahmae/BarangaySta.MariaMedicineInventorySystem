Public Class ViewUnit
    ...
    Public Sub searchstock(tb As String)
        Try
            ...
            dbConnect()
            Dim i As Integer = 0
            query = "SELECT * FROM unit WHERE " _
                                  & " UnitName Like '" & tb & "%'
                                   ORDER BY UnitName"
    ...
    Private Sub UnitDG_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles UnitDG.CellContentClick
        If e.ColumnIndex = 3 Then


            Dim id As Integer
            id = (UnitDG.SelectedRows(0).Cells(0).Value)
    ...
    Private Sub UnitDG_CellPainting(sender As Object, e As DataGridViewCellPaintingEventArgs) Handles UnitDG.CellPainting
