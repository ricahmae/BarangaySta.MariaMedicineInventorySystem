...
Public Class ViewStocksCR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Health_Center_Profiling_System.ViewStocksCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedViewStocksCR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ViewStocksCR = New ViewStocksCR()
        rpt.Site = Me.Site
        Return rpt
    End Function
